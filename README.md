...
# Материалы домашнего задания на тему «2.2. Основы Git»

## Задание 1

1. Создал репозитории на gitlab.com, bitbucket.org. 
2. Нагенерировал еще ssh-ключей для каждого аккаунта в отдельности (потренировался).
3. Добавил альясы на удаленные репозитории к локальному проекту.
4. Попробовал запушить текущее состояние локального репозитория в новые удаленные репозитории:
   1. основные ветки (main) в удаленных репозиториях защищены от пушей и это хорошо. Сделать пуш по заданию в main неудалось!
   2. запушил учебные ветки и ветку master вместо main. На удаленных репах новые ветки появились автоматически!

## Задание 2

1. Создадим новый коммит, куда добавим измененный README.md
2. Добавим к коммиту под HEAD легковесный тэг v0.0 и аннотированный тэг v0.1 (два разных тэга на оддин коммит???)
   1. Тут возникнут проблеммы, т.к. при просмотре видео я уже сам наделал тэгов. Так что удалим и сделаем согласно заданию!